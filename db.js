// db.js — Base de datos en archivo JSON
const fs   = require('fs');
...
const SEED = {
  usuarios: [
    { id:1, username:'admin',    password:'1234', nombre:'Administrador',     rol:'Administrador'      },
    { id:2, username:'operador', password:'1234', nombre:'Operador de Rutas', rol:'Operador de Rutas'  }
  ],
  rutas: [
